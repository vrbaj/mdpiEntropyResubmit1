...
found_best = False
seed_counter = 200 #96, 156, 158 167 192 ok 195 TOP
while not(found_best):
    ...
    honu_filter = pa.filters.FilterRLS(filter_len, mu=0.1, w="random")
...
plt.savefig('trendchange_rls.eps', format='eps', dpi=300)
